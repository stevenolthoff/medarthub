    ...
    <div id="but-why" className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-6 text-base leading-8 text-gray-600 sm:text-lg">
          <p>
            Early medical illustrators made careers off drawing for textbooks. It is now 2025. There are only so many textbooks to draw but hundreds of new medical illustrators graduate each year.
          </p>
          <p>
